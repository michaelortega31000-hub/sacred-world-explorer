...
export function inferReligionFromPlace(type: string, name: string): Religion {
  ...
  // Bouddhisme
  if (lowerType.includes('temple') || lowerType.includes('pagode') || 
      lowerType.includes('stupa') || lowerType.includes('wat') ||
      lowerName.includes('buddha') || lowerName.includes('bouddha') ||
      lowerName.includes('temple') && (lowerName.includes('thai') || lowerName.includes('tibetan') || lowerName.includes('zen') || lowerName.includes('shaolin')) ||
  ...
  // Hindouisme
  if (lowerType.includes('temple') && (lowerName.includes('hindu') || lowerName.includes('shiva') || 
      lowerName.includes('vishnu') || lowerName.includes('krishna') || lowerName.includes('hanuman')) ||
      lowerName.includes('meenakshi') || lowerName.includes('golden temple') ||
      lowerName.includes('akshardham') || lowerName.includes('pashupatinath') ||
      lowerName.includes('varanasi') || lowerName.includes('prambanan')) {
    return 'hinduism';
  }
  
  // Sites astronomiques ou anciens
  if (lowerName.includes('stonehenge') || lowerName.includes('pyramids') || 
      ...
      lowerName.includes('uluru')) {
    return 'astronomy';
  }
  
  // Christianisme (par défaut pour cathédrales, basiliques, églises, etc.)
