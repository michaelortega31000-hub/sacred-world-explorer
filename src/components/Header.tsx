...
{/* 1. Identité chrétienne (croix dorée) - agrandie & glow doré doux */}
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2">
              <img src={logo} alt="SacredWorld Logo" className="h-24 w-24 sm:h-32 sm:w-32 object-contain cursor-pointer" onClick={() => navigate('/explore')} />
            </div>
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              {onAssistantClick && (
                <div
                  ...
                  className="flex items-center justify-center w-14 h-14 rounded-full bg-primary/20 backdrop-blur-sm shadow-md border border-primary/40 overflow-hidden cursor-pointer hover:bg-primary/30 transition-colors text-primary"
                ...
                >
                  <MessageCircle className="w-7 h-7 text-primary border-amber-300" />
                </div>
              )}
