...
import { User, Globe, MapPin, BookOpen, Trophy } from 'lucide-react';
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center gap-1 py-2 rounded-lg transition-all duration-300 ${
                  active 
                    ? 'text-primary' 
