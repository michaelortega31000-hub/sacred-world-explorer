...
// Sacred places dataset — Phase 21 cleanup
// - Deduplicated (key: name|city|country, French-locale normalized)
// - Curated: all Christian sites + iconic non-Christian world heritage
// - Sorted by country → city → name (French locale)
// - Total: 260 places
export const mockPlaces: Place[] = [
  ...
  },
  {
    ...
    "city": "Rio de Janeiro",
    "type": "Statue",
    "description": "Inaugurée en 1931 au sommet du mont Corcovado à 710 mètres d'altitude, la statue du Christ Rédempteur de 38 mètres domine Rio de Janeiro les bras ouverts. Œuvre Art déco du sculpteur Paul Landowski, elle est devenue l'un des symboles du Brésil et du christianisme dans le monde. Classée parmi les Sept Nouvelles Merveilles du monde en 2007, elle accueille chaque année des millions de pèlerins et visiteurs venus contempler ce geste universel d'accueil et de paix.",
    "points": 100,
    "coordinates": [
      -43.2105,
      -22.9519
  ...
  },
  {
    ...
    "city": "Jérusalem",
    "type": "Site sacré",
    "description": "Vestige du Second Temple de Jérusalem détruit en 70 ap. J.-C., le Mur des Lamentations (Kotel) est le lieu de prière le plus sacré du judaïsme. Pèlerins et fidèles du monde entier viennent y déposer des prières manuscrites entre les pierres millénaires. Symbole de la persistance du peuple juif et de l'attachement à Jérusalem, il jouxte l'Esplanade des Mosquées, faisant de ce site l'un des plus chargés spirituellement au monde.",
    "points": 100,
    "coordinates": [
      35.2345,
      31.7767
